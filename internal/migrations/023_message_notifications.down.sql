-- Message notifications did not exist before this migration. Remove them
-- before restoring the previous category constraint during a rollback.
...
DELETE FROM notifications WHERE category = 'messages';
